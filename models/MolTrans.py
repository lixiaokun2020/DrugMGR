...
class Moltrans(nn.Module):
    ...
    def __init__(self, **config):
        ...
        self.d_encoder = Encoder_MultipleLayers(self.layers, self.hidden_size, self.intermediate_size,
                                                self.num_attention_heads, self.attention_probs_dropout_prob,
                                                self.hidden_dropout_prob)

        self.fc = nn.Linear(self.max_d*self.emb_size, 128)


    def forward(self, d, d_mask):
        ...
        sub = self.d_encoder(d_emb.float(), ex_d_mask.float())

        # sub = d_encoded_layers.view(-1,self.max_d*self.emb_size)
        return sub
